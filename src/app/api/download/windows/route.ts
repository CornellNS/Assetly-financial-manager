...
import {
  ...
  ASSETLY_WINDOWS_BLOB_PATHNAME,
  ASSETLY_WINDOWS_FILENAME,
...
export async function GET(request: NextRequest) {
  ...
  const signedToken = await issueSignedToken({
    operations: ["get", "head"],
    pathname: ASSETLY_WINDOWS_BLOB_PATHNAME,
  ...
  downloadUrl.searchParams.set("filename", ASSETLY_WINDOWS_FILENAME);
